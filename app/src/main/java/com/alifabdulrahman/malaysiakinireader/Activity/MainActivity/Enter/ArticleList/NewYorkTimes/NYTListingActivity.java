package com.alifabdulrahman.malaysiakinireader.Activity.MainActivity.Enter.ArticleList.NewYorkTimes;
...
public class NYTListingActivity extends AppCompatActivity implements Serializable {
    ...
    private com.alifabdulrahman.malaysiakinireader.Model.Sorter.sorting sorting;
    private com.alifabdulrahman.malaysiakinireader.Storage.Substorage.settings settings;
    private com.alifabdulrahman.malaysiakinireader.Storage.Substorage.currentArticle currentArticle;
    private com.alifabdulrahman.malaysiakinireader.Storage.Substorage.currentRSS currentRSS;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new NYTListingActivity.compareRSS().execute();
    ...
    private void setupListView() {
        ...
        if (articleDatas.isEmpty())
            new NYTListingActivity.GetContents(NYTListingActivity.this).execute();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                currentArticle = new currentArticle(NYTListingActivity.this);
    ...
    public class GetContents extends AsyncTask<String, Void, ArrayList<String>> {
        ...
        public GetContents(NYTListingActivity thisActivity){
    ...
    public class CheckNewContents extends AsyncTask<String, Void, ArrayList<String>> {
        ...
        protected void onPostExecute(ArrayList<String> dummy) {
            ...
            if (newContentAvailable) {
                ...
                Toast.makeText(NYTListingActivity.this, "No new contents available", Toast.LENGTH_LONG).show();
            }
    ...
    Runnable timedTask = new Runnable() {
        public void run() {
            ...
            new NYTListingActivity.CheckNewContents().execute();
        }
    };
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch(item.getItemId()) {
            ...
            case R.id.reset:
                ...
                Toast.makeText(NYTListingActivity.this, "Article list cleared. Refreshing...", Toast.LENGTH_LONG).show();
                articleDatas2 = new ArrayList<>();
                new NYTListingActivity.GetContents(this).execute();
                return true;
    ...
    public void loadLastArticle(){
        ...
        if (currentArticle.loadReading()){
            Intent intent = new Intent(NYTListingActivity.this, ArticleViewActivity.class);
